...
#define DEFAULT_I_VALUE  (0.13f)	//(0.325f)
#define DEFAULT_D_VALUE  (36.0f)	//(36.0f)

#define DEFAULT_LP_VALUE  (10.00f)        //(7.0f)
#define DEFAULT_LI_VALUE  (0.13f)        //(0.325f)
...
void factoryResetEEPROM() {
	...
	uint8_t vRefBase[] = {127,127,127,86,86};  //(AB maxed out)

	/// Write 'MainBoard' settings
#ifdef MODEL_REPLICATOR
#define THE_REPLICATOR_STR "3D Printer"
...
void setToolHeadCount(uint8_t count) {
	...
	eeprom_write_byte((uint8_t*)eeprom_offsets::LANGUAGE, 0);
	eeprom_write_byte((uint8_t*)eeprom_offsets::WIFI_SD, 0);
}
