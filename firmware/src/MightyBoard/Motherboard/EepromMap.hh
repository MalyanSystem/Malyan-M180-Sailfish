...
namespace replicator_axis_offsets{
	...
	//M300
/*        const static uint32_t DUAL_X_OFFSET_STEPS   = 18644L;
        const static uint32_t SINGLE_X_OFFSET_STEPS = 18644L;
        const static uint32_t DUAL_Y_OFFSET_STEPS   =  11999L;
        const static uint32_t SINGLE_Y_OFFSET_STEPS =  11999L;
*/
#endif
	/// Footnote:
	/// mm offsets
...
namespace replicator_axis_max_feedrates{
	...
	const static uint32_t axis_max_feedrates[5] = {18000, 18000, 450, 1600, 1600};
}
...
#else
	const static uint32_t axis_steps_per_mm[5] = { 92300000, 92300000, 1600000000, 88000000, 88000000};
#endif
...
const static uint16_t LANGUAGE                  = 0x0211;
const static uint16_t WIFI_SD                   = 0x0212;

/// start of free space
const static uint16_t FREE_EEPROM_STARTS        = 0x0213;
